package io.vonley.mi.di.services.impl
 ...
 * Test to speech
 */
class VoiceServiceImpl(val context: Application, override val manager: SharedPreferenceManager) : VoiceService {
    ...
    companion object {
        val TAG = VoiceServiceImpl::class.java.name
    }
